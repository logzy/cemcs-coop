<template>
        ...
        <div class="admin-top-bar-left">
          ...
          <div @click = "switchView('Vehicle')" class="admin-top-barlinks" :class="[currentTab == 1 ? currentClass : '']">Vehicle Insurance</div>
...
<script>
import Leftbar from '../../../components/leftbar/leftbarInsurance'
